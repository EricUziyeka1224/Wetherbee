...
class SignUpScreen extends React.Component {
    ...
    const height = Dimensions.get('window').height
      return (
              ...
              <View style={{width: '100%', top: height * .29, flexDirection: 'column', position: 'absolute',}}>
              <View style={{boxSizing: 'border-box',
                            height: 48,
                            width: '78.67%',
                            border: '1px solid rgba(255,255,255,0.24)',
              ...
              borderRadius: 27,
              backgroundColor: '#FFFFFF',
              top: 17.5+17.5+17.5+(height * .093)/*height * .6872*/,
              left: '10.67%',
              justifyContent: 'center',
              alignItems: 'center',
              }}
              ...
              top: /*height * .7906*/17.5+17.5+17.5+(height * .093)+(height * .0369), justifyContent: 'center', alignItems: 'center', height: 45
              }}>
              <Text style={{
                  height: 45,
                  color: '#FFFFFF',
